...
echo "      info "   sudo nano $MAIN_MANIFEST_CONFIG_PATH"
...
echo "        b. Edit your new project configuration file with your specific database details, S3 settings (if any),"
...
echo ""
echo "     3. If using S3 cloud backups, configure your AWS credentials (if not already done):"
