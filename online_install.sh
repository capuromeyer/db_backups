...
echo "        from '$FINAL_USER_CONF_D_DIR/'."
echo ""
echo "      2. - Create your project-specific configuration(s):"
echo "        a. Copy the sample project configuration:"
echo "          sudo cp $FINAL_SAMPLE_CONF_D_DIR/project01.conf.sample $FINAL_USER_CONF_D_DIR/my_project.conf"
...
echo "        sudo $SCRIPT_INSTALL_DIR/dbb-tester.sh"
echo ""
