...
# Purpose: Orchestrates hourly backups using SQLite-based two-stage validation.
#          Uses lib/master_config_file_utils.sh for SQLite DB setup,
#          initial validation, duplicate checks, and reporting.
